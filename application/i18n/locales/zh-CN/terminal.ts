...
export const zhCNTerminalMessages: Messages = {
  ...
  'settings.terminal.keyboard.inputMethodMemory.checking': '正在检查原生输入法支持，仍可更改并保存此设置。',
  'settings.terminal.keyboard.inputMethodMemory.unsupported': '原生输入法支持当前不可用，此设置仍会保留。',
  'settings.terminal.keyboard.inputMethodMemory.unsupportedPlatform': '此功能仅在 Windows 上生效，此设置仍会保留。',
  'settings.terminal.keyboard.inputMethodMemory.retry': '重新检查',
